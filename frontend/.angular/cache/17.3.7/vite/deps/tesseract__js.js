...
var require_createWorker = __commonJS({
  "node_modules/tesseract.js/src/createWorker.js"(exports, module) {
    ...
    var workerCounter = 0;
    module.exports = (..._0) => __async(exports, [..._0], function* (langs = "eng", oem = OEM.LSTM_ONLY, _options = {}, config = {}) {
      ...
      const recognize = (_02, ..._1) => __async(exports, [_02, ..._1], function* (image, opts = {}, output = {
        blocks: true,
        text: true,
        hocr: true,
        tsv: true
